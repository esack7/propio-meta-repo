...
| Cursor native discovery | **Unverified** | `.cursor/commands/` and `.cursor/rules/` wrapper structure and canonical targets are tested; live command and rule loading requires an interactive Cursor session. |
